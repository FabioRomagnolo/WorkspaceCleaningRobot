...
service_name = 'dirty_detection'

CLEANING_STATE_TOPIC = 'cleaning_state'
import std_msgs.msg

cleaning_state_pub = rospy.Publisher('cleaning_state', std_msgs.msg.String, queue_size=1)
...
if __name__ == '__main__':
	...
	s = rospy.Service(service_name, Image, handle_request)
